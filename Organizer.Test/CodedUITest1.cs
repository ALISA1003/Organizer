...
namespace Organizer.Test
{
    ...
    public class CodedUITest1
    {
        ...
        //Тестирование выполнения задачи
        [TestMethod]
        public void TestOfComplite()
        {
            this.UIMap.OpenApplication();
            this.UIMap.ClickContinue();
            this.UIMap.CheckComplite();
            this.UIMap.CloseApplication();
        }

        //Тестирования сохранения списков в файлы и загрузки их из файлов
        [TestMethod]
        public void TestOfSaveTasks()
        {
            this.UIMap.OpenApplication();
            this.UIMap.AddTasks();
            this.UIMap.ClickCompliteMeet();
            this.UIMap.CloseApplication();
            this.UIMap.OpenApplication();
            this.UIMap.CheckToDoList();
            this.UIMap.CheckAccompList();
            this.UIMap.CloseApplication();
        }
